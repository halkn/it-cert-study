...
## 各誤答が誤りである理由
- A: FINANCE_ROLEをprimaryにすれば新規object ownerの要件を満たし、両account roleをsecondaryでactiveにすればjoinに必要なprivilegeを集約できます。
- B: 両databaseをjoinできても、新規objectのownerはprimaryであるDB_Aのaccount roleになり、FINANCE_ROLEという要件を満たしません。
