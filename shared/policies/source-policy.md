...
1. 試験範囲: 認定団体の公式Certification Page / Study Guide
2. 技術仕様・概念・操作: 製品・技術の公式Documentation
3. 変更されうる状態: 公式Release Notes / Behavior Change / announcement

非公式ブログ、Q&A、動画、試験対策サイト、Exam Dump、LLM の内部知識は技術的事実の根拠にしません。探索のきっかけに使った場合も、教材に反映する前に認定団体または技術提供元の公式資料で確認します。

## 出典台帳

参照資料は各試験パッケージの `docs/sources.json` に一意な ID で登録します。
